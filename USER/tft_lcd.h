...
#define Bank1_LCD_D    ((u32) (0x60020000|0x00040000) )     
#define Bank1_LCD_C    ((u32) (0x60000000|0x00040000) )	   	 
...
#define	LCD_PREPARE_WR()	LCD_WR_REG(0x22)



//背光控制		 
#define	LCD_BG_ON()		GPIO_ResetBits(GPIOB, GPIO_Pin_0);
#define	LCD_BG_OFF()	GPIO_SetBits(GPIOB, GPIO_Pin_0);
...
void LCD_ClrFix(u16,u16 y,u16 x_len,u16 y_len);
